...
type Props = { channel: string; channelIcon: "#" | "@"; onSend: (message: string, files: File[]) => Promise<void>; onTyping: (typing: boolean) => void };

export function MessageComposer({ channel, channelIcon, onSend, onTyping }: Props) {
