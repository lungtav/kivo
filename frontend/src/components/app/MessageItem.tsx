...
export type Message = { id: string; author: string; initials: string; timestamp: string; body: string; accent: "violet" | "cyan" | "amber"; isOwn: boolean; sentAt: Date; edited?: boolean; deleted?: boolean; attachments?: { id: string; mediaType: string; mimeType: string }[]; replyTo?: { id: string; author: string; body: string } };
