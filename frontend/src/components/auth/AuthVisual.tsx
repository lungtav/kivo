    ...
    <div className="relative h-full overflow-hidden bg-black p-8 text-white xl:p-12">
      ...
      <div className="relative flex h-full flex-col">
        ...
        <div className="my-auto w-full max-w-xl">
          ...
          <h2 className="mt-4 max-w-lg text-3xl font-semibold tracking-[-0.04em] xl:text-4xl">
            Less noise. More room for the conversation.
          </h2>
          <p className="mt-3 max-w-md text-sm leading-6 text-white/55">
            Kivo keeps your team’s channels, messages, and decisions in one calm
            space.
          </p>
          <div className="mt-8">
            <WorkspacePreview />
        ...
        <p className="text-xs text-white/35">
          Built for teams, friends, and communities.
        </p>
      </div>
    </div>
  );
