...
export default function CheckEmailPage() {
  ...
  const email =
    state?.email ??
    sessionStorage.getItem("kivo_pending_verification_email") ??
    undefined;
  return (
    <AuthLayout>
      <Brand />
      <div className="mt-14">
        ...
        <h1 className="mt-2 text-4xl font-bold tracking-[-.045em] text-black">
          Check your inbox
        </h1>
        <p className="mt-4 max-w-sm text-sm leading-6 text-neutral-500">
          We sent a verification link
          {email ? ` to ${email}` : " to your email address"}. Open it to
          activate your Kivo account.
        </p>
